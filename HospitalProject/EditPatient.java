...
public class EditPatient extends JPanel {
	...
	public EditPatient() {
		...
		label.setIcon(new ImageIcon(EditPatient.class.getResource("/images/editRecord.png")));
		...
		textField.setBounds(642, 357, 196, 54);
		add(textField);
		...
		label_1.setIcon(new ImageIcon(EditPatient.class.getResource("/images/sidebar6.png")));
		label_1.setBounds(1066, 190, 66, 413);
		add(label_1);
		...
		label_2.setIcon(new ImageIcon(EditPatient.class.getResource("/images/seperator.png")));
		label_2.setBounds(524, 189, 46, 427);
		add(label_2);
		
		JLabel label_3 = new JLabel("");
		label_3.setIcon(new ImageIcon(EditPatient.class.getResource("/images/seperator.png")));
	...
	public static void create() {
		...
		f.getContentPane().add(new EditPatient());
